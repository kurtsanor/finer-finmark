        ...
        <aside className="border border-neutral-300 w-80 h-fit rounded">
          <div className="p-4">
            ...
            <button
              ...
              className="w-full flex items-center disabled:opacity-50 disabled:hover:bg-black justify-center gap-2 rounded bg-black py-2 mt-5 font-semibold text-white transition-colors hover:bg-slate-800 active:scale-[0.99]"
            >
              <svg
