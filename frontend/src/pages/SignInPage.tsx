...
/*
 * SignInPage
 * Renders the sign-in form and handles user authentication requests.
 */
...
const SignInPage = () => {
  ...
  const onSubmit = async (data: SignInFormValues) => {
    try {
      ...
      toast(error.response?.data?.error || "An error occurred during sign-in");
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="border border-neutral-200 text- hover:bg-neutral-100 text-black p-1.5 mt-2 tracking-tight flex items-center justify-center gap-2 transition-colors"
      >
        <svg
